...
<head>
    ...
    <title>Italian Catering Menus | Catering Antipasti</title>
            ...
            <div id="custom-menu" class="menu-section hidden">
                <div class="max-w-4xl mx-auto bg-verona p-8 rounded-lg">
                    ...
                    <div id="menu-summary" class="mt-8 p-6 bg-white rounded-lg hidden">
                        <h4 class="font-serif text-xl text-sangiovese mb-2">Your selection:</h4>
                        <p class="text-sm text-seagray mb-4">We get back with a tailored concept and quote.</p>
